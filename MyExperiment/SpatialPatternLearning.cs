...
namespace NeoCortexApiSample
{
    ...
    public class SpatialPatternLearning
    {
        ...
        public SpatialPatternLearning(double maxValue)
        {
            max = maxValue;
        }
        public void Run()
        ...
        private void RunRustructuringExperiment(SpatialPooler sp, EncoderBase encoder, List<double> inputValues)
        {
            ...
            string differenceHeatmapFolderPath = Path.Combine(Environment.CurrentDirectory, "DifferenceHeatmapImages");

            // Generate the Difference Heatmaps using the normalized and encoded data
            NeoCortexUtils.GenerateDifferenceHeatmaps(normalizedPermanence, encodedInputs, differenceHeatmapFolderPath, 100, 1, 30);
        }
